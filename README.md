# Docstring-AI 🤖✨: **Automate your Python Documentation with AI**
...
Docstring-AI is an advanced tool that **generate high-quality Python docstrings** for your codebase. 

### Why Docstring-AI ? 

While training a LLM over a Project Codebase, I decided to perform **data augmentation** or **metadata generation** to improve the dataset by enhancing docstrings of the source code.
...
5. [🏃‍♂️ Running Docstring-AI](#-running-docstring-ai)
6. [📝 Understanding Flags](#-understanding-flags)
   - [General Flags](#general-flags)
   - [GitHub Integration Flags](#github-integration-flags)
   - [Advanced Flags](#advanced-flags)
7. [🔍 Detailed Explanation of Git Flags](#-detailed-explanation-of-git-flags)
   - [Priority Policies](#priority-policies)
   - [Priority Process](#priority-process)
8. [🔍 Explanation of `--pr-depth`](#-explanation-of-pr-depth)
9. [🔍 Manual Validation Workflow](#-manual-validation-workflow)
